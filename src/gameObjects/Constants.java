...
/*  Dentro de esta clase se encuentran todos los valores que no seran afectados a lo largo del juego.
En este caso las dimensiones de la pantalla de juego, la velocidad de disparo, la velocidad de rotacion de la nave, la velocidad de la nave,
entre otras cosas.
*/
...
public class Constants {
	...
	public static final String SCORE_PATH = FileSystemView.getFileSystemView().getDefaultDirectory().getPath() + "\\Space_Ship_Game\\data.json"; // data.xml if you use XMLParser
