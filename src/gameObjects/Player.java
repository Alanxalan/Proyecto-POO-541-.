...
public class Player extends MovingObject{
	...
	public void update(float dt) 
	{
		...
		//En estos if se hace la pregunta de si la primer variable es mayor al tiempo del segundo, si se cumple hara lo que contiene dentro.
		...
		//En estas condiciones son para el desplazamiento con las flechas.
		if(KeyBoard.RIGHT)
