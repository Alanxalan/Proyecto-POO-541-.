...
public class Player extends MovingObject{
    ...
    private static final Vector2D datos = new Vector2D(Constants.WIDTH/2 - Assets.player.getWidth()/2, Constants.HEIGHT/2 - Assets.player.getHeight()/2);
